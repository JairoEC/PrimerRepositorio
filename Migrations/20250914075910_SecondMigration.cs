    ...
    public partial class SecondMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    SaleId = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    DateSale = table.Column<DateTime>(type: "timestamp", nullable: false, defaultValueSql: "NOW()"),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Cliente, comprador, o usuario", "Customer" },
                    { 2, "Empleado, cajero", "Seller" }
                });
            ...
            migrationBuilder.UpdateData(
                ...
                values: new object[] { "jhon@gmail.com", "123123", 1 });

            migrationBuilder.InsertData(
                table: "Seller",
                columns: new[] { "SellerId", "RoleId", "SellerName" },
                values: new object[] { 1, 2, "Nicolas Bravo" });
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.UpdateData(
                ...
                values: new object[] { "Jhon@gmail.com", "123" });
